...
//         try {
//           await api.post("/create-or-update", {
//             clerkId: completeSignUp.userId, // ✅ FIXED
...
//         } catch (dbError) {
//           console.error("MongoDB Sync Failed", dbError);
//         }
...
//           maxLength={6}
//           className="w-full p-4 border border-gray-300 rounded-xl mb-6 text-center text-lg tracking-widest"
//         />
...
//           className="mt-4"
//         >
//           <Text className="text-center text-gray-500">Back to Sign Up</Text>
//         </TouchableOpacity>
//       </View>
//     );
//   }
...
//           resizeMode="contain"
//         />
//         <Text className="text-xl font-bold mt-2">Welcome to playVenue</Text>
...
//       {/* EMAIL */}
//       <Text className="font-semibold ml-1">Email *</Text>
//       <Controller
//         control={control}
//         name="email"
...
//             autoCapitalize="none"
//             className="w-full p-4 my-2 border rounded-xl"
...
//       {/* PASSWORD */}
//       <Text className="font-semibold ml-1 mt-2">Password *</Text>
//       <Controller
//         control={control}
//         name="password"
//         render={({ field: { onChange, value } }) => (
//           <View
//             className="flex-row items-center border rounded-xl my-2"
...
//         className="bg-black py-4 rounded-xl mt-8"
//       >
//         {isSubmitting ? (
//           <ActivityIndicator color="white" />
//         ) : (
  ...
  const onVerifyPress = async () => {
    ...
    try {
      ...
      if (completeSignUp.status === "complete") {
        ...
        try {
          const userData = {
            clerkId: completeSignUp.createdUserId, // ✅ Correct ID for SignUp
            email: emailValue,
          ...
          console.log("Syncing user to MongoDB...", userData);
          await api.post("/create-or-update", userData);
          console.log("MongoDB Sync Success");
        } catch (dbError: any) {
          // Log error but don't block navigation since user is verified in Clerk
